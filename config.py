...
confidence = 0.4                         # Prediction confidence threshold
target_candle = 100                      # Future candle to predict
profit_perc = 0.5                       # Take profit percentage
stop_loss_perc = profit_perc/2                    # Stop loss percentage
